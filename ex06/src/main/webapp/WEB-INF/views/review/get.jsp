                ...
                <main class="content">
                    <div class="main-card">
                        ...
                        <div class="edit-actions">
                          <a href="${pageContext.request.contextPath}/review/list"><button type="button" class="btn-list">리스트</button></a>
                         <a class="btn-modifty" href="${pageContext.request.contextPath}/review/modify?review_id=${review.review_id}">수정</a>
                        </div>
